...
ch3_noise_arr = np.load("../phase_noise_dic/PoB_ch1_dic.npy", allow_pickle=True)
noise_arr = np.load("../phase_noise_dic/PoB_ch3_dic.npy", allow_pickle=True)
xl_path = "..\\phase_noise_dic\\PoB_total.xlsx"
