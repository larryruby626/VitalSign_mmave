...
if __name__ == "__main__":
    ...
    f = np.load("D:\\kkt_dataset\\dataset1101109\\Phase_Buff\\Automatic_peak\\sic255\\HR_20cm_time1.npy", allow_pickle=True)
    ...
    for i in range(out_len):
        ...
        peak = find_peaks(fftspectral,height=fftspectral.max()-5)
