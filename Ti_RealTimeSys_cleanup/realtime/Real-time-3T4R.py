...
# set_radar = SerialConfig(name='ConnectRadar', CLIPort='COM49', BaudRate=115200)  # connect to your comport
# set_radar = SerialConfig(name='ConnectRadar', CLIPort='COM58', BaudRate=115200)  # connect to your comport
set_radar = SerialConfig(name='ConnectRadar', CLIPort='COM31', BaudRate=115200)  # connect to your comport
